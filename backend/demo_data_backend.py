def GET_MOCK_REPORT(title: str):
    """
    Returns a high-fidelity mock report for 'Attention Is All You Need' or default paper,
    specifically designed to showcase the peer-review Auditor Agent, the Argument-Evidence map, 
    contextual interventions, and ELI5 summaries.
    """
    return {
        "paper_id": "attention_is_all_you_need",
        "title": title or "Attention Is All You Need",
        "summary": (
            "The paper proposes the Transformer, a novel network architecture based solely on attention mechanisms, "
            ...
            "less time to train. The model achieves 28.4 BLEU on English-to-German and 41.8 BLEU on English-to-French, "
            "establishing a new state-of-the-art."
        ),
        "eli5_summary": (
            "Imagine a crowded cocktail party. Instead of listening to everyone from left to right (like RNNs do), "
            "you immediately focus only on the people talking about topics relevant to you. That's Self-Attention. "
            "The Transformer architecture replaces the slow 'word-by-word' processing of older models with a parallel "
            "system where words can 'talk' to all other words simultaneously. It's like reading an entire page of a book "
            "at once rather than scanning it word-by-word with a magnifying glass."
        ),
        "claims": [
            {
                "id": "claim_1",
